<?php
class respostas_prova3Controller {
    ...
    public function salvarDesempenho() {
        ...
        $stmt = $conn->prepare("INSERT INTO desempenho_provas (usuario_id, prova, acertos, erros, tempo_gasto, pontuacao, data_execucao) VALUES (?, 'Prova 3', ?, ?, ?, ?, NOW())");
