...
<body>
  ...
  <header id="topo">
    <div class="header-top">
      ...
      <div class="login-container">
        <a href="<?= BASE_URL ?>?page=home" class="category-link1">Voltar</a>
  ...
  <main class="main-content">
    ...
    <div class="prova-list">
      <img src="<?= PROVABLOQ_ASSETS ?>imgs/provabloq.png" alt="Simulado">
  ...
  <script>
    ...
    window.SIMULAETEC_CONFIG = {
      ...
      PROVA_ASSETS: '<?= defined('PROVA_ASSETS') ? PROVABLOQ_ASSETS : '/public/assets/prova/' ?>',
