...
<script>
 ...
 <script>
   document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lista de questões
    const questions = [
        { image: PROVA1_ASSETS + '<?= PROVA1_ASSETS ?>imgs/imgprovas/intro.png', requiresAnswer: false }, 
        { image: PROVA1_ASSETS + '<?= PROVA1_ASSETS ?>imgs/imgprovas/quest1.png', requiresAnswer: true },    
